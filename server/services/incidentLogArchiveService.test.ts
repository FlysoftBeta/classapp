...
import { buildIncidentLogArchive } from "./incidentLogArchiveService";
...
assert.deepEqual(Object.keys(emptyArchive), ["manifest.json"]);

console.log("incident log archive tests passed");
