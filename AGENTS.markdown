...
| music search, library caching, streaming         | `lib/music/`, `server/services/musicService.ts`, `server/domain/facade/music.ts`, `server/http/routes/music*`, `client/interact/music.ts`, `client/components/music/`                                                 | [music](./docs/systems/music.md)                                                                                                                                                                         |
